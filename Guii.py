...
def adder():
    ...
    btnk3 = tk.Button(rootk, text='Добавить сервисный ордер', command=service_order)  # добавить запись
    btnk3.pack()

    btnk4 = tk.Button(rootk, text='Добавить инцидент', command=incidents)
    btnk4.pack()

    btnk5 = tk.Button(rootk, text='Добавить сотрудника на выезд', command=emp_on_order)  # добавить запись
    btnk5.pack()

    btnk6 = tk.Button(rootk, text='Заказ', command=add_order)  # добавить запись
    btnk6.pack()
...
def service_order():
    root1=tk.Tk()
    root1.title('Добавление сервисного ордера')
    root1.geometry("500x350+150+200")

    id0 = tk.StringVar()
    dates0 = tk.StringVar()
    datee0 = tk.StringVar()
    reason0 = tk.StringVar()
    licplate0= tk.StringVar()

    l1 = tk.Label(root1, text='ID инцидента')
    l1.place(x=20, y=10)
    id = tk.Entry(root1, textvariable=id0)  # работает
    id.place(x=190, y=13)

    l2 = tk.Label(root1, text='Дата начала')
    l2.place(x=20, y=40)
    fname = tk.Entry(root1, textvariable=dates0)  # работает
    fname.place(x=190, y=41)

    l3 = tk.Label(root1, text='Дата окончания')
    l3.place(x=20, y=80)
    lname = tk.Entry(root1, textvariable=datee0)  # работает
    lname.place(x=190, y=80)

    l4 = tk.Label(root1, text='Причина')
    l4.place(x=20, y=110)
    sname = tk.Entry(root1, textvariable=reason0)  # работает
    sname.place(x=190, y=110)

    l5 = tk.Label(root1, text='Номер машины')
    l5.place(x=20, y=140)
    passid = tk.Entry(root1, textvariable=licplate0)  # работает
    passid.place(x=190, y=140)
...
def incidents():
    ...
    l1 = tk.Label(root1, text='ID инцидента')
    l1.place(x=20, y=10)
    id = tk.Entry(root1, textvariable=a01)  # работает
    id.place(x=190, y=13)

    l2 = tk.Label(root1, text='Дата')
    l2.place(x=20, y=40)
    fname = tk.Entry(root1, textvariable=a02)  # работает
    fname.place(x=190, y=41)

    l3 = tk.Label(root1, text='Место')
    l3.place(x=20, y=80)
    lname = tk.Entry(root1, textvariable=a03)  # работает
    lname.place(x=190, y=80)

    l4 = tk.Label(root1, text='Ущерб')
    l4.place(x=20, y=110)
    sname = tk.Entry(root1, textvariable=a04)  # работает
    sname.place(x=190, y=110)

    l5 = tk.Label(root1, text='Ошибка клиента')
    l5.place(x=20, y=140)
    passid = tk.Entry(root1, textvariable=a05)  # работает
    passid.place(x=190, y=140)

    l6 = tk.Label(root1, text='ID ордера')
    l6.place(x=20, y=170)
    hiredate = tk.Entry(root1, textvariable=a06)  # работает
    hiredate.place(x=190, y=170)

    l7 = tk.Label(root1, text='ID ордера 2')
    l7.place(x=20, y=200)
    birthdate = tk.Entry(root1, textvariable=a07)  # работает
    birthdate.place(x=190, y=200)
...
def emp_on_order():
    root1 = tk.Tk()
    root1.title('Добавить сотрудника на выезд')
    root1.geometry("500x350+150+200")
    ...
    l1 = tk.Label(root1, text='ID ордера 2')
    l1.place(x=20, y=10)
    id = tk.Entry(root1, textvariable=a01)  # работает
    id.place(x=190, y=13)

    l2 = tk.Label(root1, text='ID сотрудника')
    l2.place(x=20, y=40)
    fname = tk.Entry(root1, textvariable=a02)  # работает
    fname.place(x=190, y=41)
...
def add_order():
    ...
    l1 = tk.Label(root1, text='ID заказа')
    l1.place(x=20, y=10)
    id = tk.Entry(root1, textvariable=a01)  # работает
    id.place(x=190, y=13)
    ...
    l4 = tk.Label(root1, text='Номер машины')
    l4.place(x=20, y=110)
    sname = tk.Entry(root1, textvariable=a04)  # работает
    sname.place(x=190, y=110)

    l5 = tk.Label(root1, text='ID клиента')
    l5.place(x=20, y=140)
    passid = tk.Entry(root1, textvariable=a05)  # работает
    passid.place(x=190, y=140)
...
btn_ex = tk.Button(root, text='Выход', command=root.destroy)
btn_ex.pack()
